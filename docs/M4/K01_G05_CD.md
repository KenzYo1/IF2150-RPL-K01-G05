...
| :--- | :--- | :--- | :--- |
| *C01* | *PelaporEntity* | *Menyimpan data akun pelapor yang membuat nama dan NIM/NIP bagi civitas akademika ITB.* | *UC01, UC04* |
| *C02* | *LaporanEntity* | *Menyimpan data laporan berupa deskripsi masalah, lokasi, bukti foto, tombol like dan banyak like-nya, beserta status validitasnya secara administrasi dan status penanganannya.* | *UC01, UC03* |
...
| *C05* | *LaporanController* | *laporanValid, statusLaporan* | *isLaporanValid(), setStatusLaporan()* |
...
| *C17* | *NotifikasiConrtroller* | *Mengarahkan pengguna pada halaman tempat laporannya disetujui atau tidak.* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C06* | *AdminEntity* | *idAdmin, namaAdmin, nipAdmin* | *getIdAdmin(), getNamaAdmin(), getNipAdmin(), setIdAdmin(), setNamaAdmin(), setNipAdmin(), setPointPelapor()* |
| *C07* | *PetugasEntity* | *idPetugas, namaPetugas, nipPetugas* | *getIdPetugas(), getNamaPetugas(), getNipPetugas(), setIdPetugas(), setNamaPetugas(), setNipPetugas(), setPointPelapor()* |
...
| *C09* | *TanggapanController* | *poinPelapor* | *getPoinPelapor(), setPoinPelapor()* |
| *C13* | *DatabaseLaporanEntity* | *??* | *?* |
| *C16* | *HalamanNotifikasi* | *listNotifikasi* | *showListNotifikasi()* |
| *C17* | *NotifikasiController* | *statusNotifikasi* | *sendNotifikasi()* |
