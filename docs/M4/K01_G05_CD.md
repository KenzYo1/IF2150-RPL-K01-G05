...
| *C07* | *PetugasEntity* | *Menyimpan data akun petugas yang memuat nama, NIP, dan sebagainya.* |
...
| *C12* | *DatabaseLaporanEntity* | *Menyimpan data formulir laporan yang telah dikirim berupa deskripsi masalah, lokasi, dan bukti foto baik yang sudah divalidasi maupun yang belum.* |
...
Bagian ini menunjukkan keterkaitan antara kelas yang telah diidentifikasi pada BAB 4, *use case* yang didukung, dan kebutuhan fungsional yang direalisasikan.

## 5.1 Traceability Kelas, Use Case, dan Kebutuhan Fungsional

| ID Kelas | Nama Kelas | ID Use Case | ID KF |
| :--- | :--- | :--- | :--- |
| **C01** | PelaporEntity | UC01, UC02, UC03, UC04 | KF03, KF06, KF07, KF10, KF11 |
| **C02** | LaporanEntity | UC01, UC02, UC03 | KF03, KF04, KF05, KF06, KF07, KF08, KF09 |
| **C03** | HalamanLaporan | UC03 | KF05, KF06, KF08 |
| **C04** | HalamanFormulirLaporan | UC01 | KF03 |
| **C05** | LaporanController | UC01 | KF03 |
| **C06** | AdminEntity | UC02 | KF04 |
| **C07** | PetugasEntity | UC02 | KF04, KF09 |
| **C08** | HalamanFormulirTanggapan | UC02 | KF04, KF09 |
| **C09** | TanggapanController | UC02, UC04 | KF04, KF09, KF10, KF11 |
| **C10** | LikeController | UC03 | KF06, KF07, KF08 |
| **C11** | HalamanLeaderboard | UC04 | KF11, KF12, KF13, KF14 |
| **C12** | DatabaseLaporanEntity | UC01, UC02, UC03 | KF03, KF04, KF05, KF06, KF07, KF08, KF09 |
| **C13** | DatabasePelaporEntity | UC04 | KF10, KF11, KF12, KF13, KF14 |
| **C14** | LeaderboardController | UC04 | KF11, KF12, KF13, KF14 |
| **C15** | HalamanAkun | UC04 | KF11, KF12 |
| **C16** | HalamanNotifikasi | UC02, UC04 | KF09, KF10, KF11 |
| **C17** | NotifikasiController | UC02, UC04 | KF09, KF10, KF11 |

## 5.2 Traceability Berdasarkan Use Case

Tabel berikut menunjukkan kelas yang mendukung realisasi setiap *use case* APATIS.

| ID Use Case | Nama Use Case | Kelas yang Mendukung |
| :--- | :--- | :--- |
| **UC01** | Melakukan pelaporan | C01 PelaporEntity, C02 LaporanEntity, C04 HalamanFormulirLaporan, C05 LaporanController, C12 DatabaseLaporanEntity |
| **UC02** | Memberikan status laporan | C01 PelaporEntity, C02 LaporanEntity, C06 AdminEntity, C07 PetugasEntity, C08 HalamanFormulirTanggapan, C09 TanggapanController, C12 DatabaseLaporanEntity, C16 HalamanNotifikasi, C17 NotifikasiController |
| **UC03** | Memberikan dan membatalkan *like* | C01 PelaporEntity, C02 LaporanEntity, C03 HalamanLaporan, C10 LikeController, C12 DatabaseLaporanEntity |
| **UC04** | Memperoleh poin | C01 PelaporEntity, C09 TanggapanController, C11 HalamanLeaderboard, C13 DatabasePelaporEntity, C14 LeaderboardController, C15 HalamanAkun, C16 HalamanNotifikasi, C17 NotifikasiController |

## 5.3 Traceability Berdasarkan Kebutuhan Fungsional

Tabel berikut menunjukkan kelas yang mendukung setiap kebutuhan fungsional APATIS.

| ID KF | Ringkasan Kebutuhan | Kelas yang Mendukung |
| :--- | :--- | :--- |
| **KF01** | Sistem memasukkan pengguna ke akun yang benar dan memberikan akses sesuai perannya | Belum dimodelkan secara khusus karena proses login merupakan prasyarat *use case* |
| **KF02** | Sistem mengidentifikasi peran pengguna sebagai Pelapor, Petugas, atau Admin | C01 PelaporEntity, C06 AdminEntity, C07 PetugasEntity; proses identifikasi peran belum memiliki kelas pengendali khusus |
| **KF03** | Pelapor membuat laporan yang berisi kategori, deskripsi, foto, waktu, dan lokasi | C01 PelaporEntity, C02 LaporanEntity, C04 HalamanFormulirLaporan, C05 LaporanController, C12 DatabaseLaporanEntity |
| **KF04** | Admin dan Petugas melihat, memvalidasi, menerima, atau menolak laporan | C02 LaporanEntity, C06 AdminEntity, C07 PetugasEntity, C08 HalamanFormulirTanggapan, C09 TanggapanController, C12 DatabaseLaporanEntity |
| **KF05** | Pengguna melihat laporan yang telah dinyatakan valid pada halaman laporan | C02 LaporanEntity, C03 HalamanLaporan, C12 DatabaseLaporanEntity |
| **KF06** | Pelapor memberikan dan membatalkan *like* pada laporan | C01 PelaporEntity, C02 LaporanEntity, C03 HalamanLaporan, C10 LikeController, C12 DatabaseLaporanEntity |
| **KF07** | Sistem membatasi satu *like* dari setiap pengguna pada satu laporan | C01 PelaporEntity, C02 LaporanEntity, C10 LikeController, C12 DatabaseLaporanEntity |
| **KF08** | Sistem memperbarui jumlah *like* setelah *like* diberikan atau dibatalkan | C02 LaporanEntity, C03 HalamanLaporan, C10 LikeController, C12 DatabaseLaporanEntity |
| **KF09** | Petugas mengubah status laporan sesuai perkembangan penanganannya | C02 LaporanEntity, C07 PetugasEntity, C08 HalamanFormulirTanggapan, C09 TanggapanController, C12 DatabaseLaporanEntity, C16 HalamanNotifikasi, C17 NotifikasiController |
| **KF10** | Sistem memberikan poin untuk laporan yang telah diterima | C01 PelaporEntity, C09 TanggapanController, C13 DatabasePelaporEntity, C16 HalamanNotifikasi, C17 NotifikasiController |
| **KF11** | Sistem memperbarui dan menampilkan jumlah poin Pelapor | C01 PelaporEntity, C09 TanggapanController, C11 HalamanLeaderboard, C13 DatabasePelaporEntity, C14 LeaderboardController, C15 HalamanAkun |
| **KF12** | Sistem membatasi informasi pengguna yang ditampilkan pada *leaderboard* | C11 HalamanLeaderboard, C13 DatabasePelaporEntity, C14 LeaderboardController, C15 HalamanAkun |
| **KF13** | Sistem menunjukkan calon penerima *merchandise* dari 20 peringkat teratas | C11 HalamanLeaderboard, C13 DatabasePelaporEntity, C14 LeaderboardController |
| **KF14** | Sistem menghitung dan menampilkan 20 peringkat teratas pada akhir periode | C11 HalamanLeaderboard, C13 DatabasePelaporEntity, C14 LeaderboardController |
