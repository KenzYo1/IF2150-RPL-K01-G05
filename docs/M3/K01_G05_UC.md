...
| No | Aksi Pelapor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
...
||| *Sistem menerima data dari kolom-kolom yang diisi pelapor secara _front-end_ dan secara bersamaan melakukan validasi teknis (misal, jumlah karakter deskripsi laporan, jenis file foto)* |
| 3 | *Pelapor mengonfirmasi pengiriman laporan* ||
||| *Sistem menerima seluruh data dari formulir laporan, kemudian mengirimnya ke Petugas untuk divalidasi kembali apakah ranah permasalahan termasuk masalah fasilitas sanitasi dan air di ITB* |
...
| No | Aksi Petugas | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Petugas menerima data laporan* ||
||| *Sistem menampilkan seluruh laporan yang belum ditanggapi* |
| 2 | *Petugas mengubah status salah satu laporan (misal, penerimaan, penolakan, dan _progress_ berupa tanggapan)* ||
||| *Sistem memperbarui data status laporan secara _front-end_ untuk dikirim nantinya* |
| 3 | *Petugas menekan tombol untuk mengirim perubahan status* ||
||| *Sistem mengirim perubahan status laporan ke database, memberi notifikasi ke pengguna yang membuat laporan, dan memberi poin ke pengguna tersebut jika laporan diterima, sebaliknya jika ditolak, laporan akan dihapus* |
<br>
