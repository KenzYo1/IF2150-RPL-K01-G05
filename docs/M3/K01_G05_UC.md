...
| :--- | :--- | :--- |
| 1 | *Pengguna login ke dalam aplikasi* | *Sistem menampilkan menu utama, yakni terdapat berbagai laporan yang telah dibuat orang lain, serta tombol untuk melapor.* |
| 2 | *Pengguna melapor dengan menekan tombol lapor, kemudian mengisi detail dari laporan, seperti tempat, foto, dan sebagainya.* | *Sistem menampilkan berbagai kolom formulir untuk diisi pengguna dan mendapatkan data laporan.* |
| 3 | *Pengguna mengonfirmasi laporan* | *Sistem menerima data-data dari laporan, melakukan validasi laporan, kemudian mengirim data ke database dan mengembalikan pesan bahwa laporan berhasil dibuat jika valid.* |


<br>

**Skenario Alternatif 1: Laporan Gagal Divalidasi**


| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Pelapor login ke dalam aplikasi* | *Sistem menampilkan menu utama, yakni terdapat laporan-laporan yang telah dibuat serta tombol untuk melapor* |
| 2 | *Pelapor menekan tombol login* | *Sistem mengarahkan pengguna ke halaman laporan* |
| 3 | *Pelapor mengisi formulir laporan* | *Laporan tidak valid, seperti foto yang di-upload terlalu besar atau format file-nya tidak sesuai atau jumlah karakter di deskripsi laporan terlalu panjang. Sistem kemudian menampilkan pesan error yang berkaitan dan menyuruh pelapor menyesuaikan kembali laporannya.* |
| 4 | *Pelapor menyesuaikan laporannya* | *Sistem kembali ke langkah 2 skenario normal* |
