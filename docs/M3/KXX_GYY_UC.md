...
| :--- | :--- | :--- | :--- | :--- |
| *UC01* | *Melakukan login di web* | *Pengguna melakukan login menggunakan akun ITB dan masuk ke peran akun yang sesuai. Setelah login pengguna dapat mengakses fitur sesuai dengan perannya.* | *Pelapor, Petugas, Admin* | *KF01, KF02* |
| *UC02* | *Melakukan pelaporan* | *Pengguna mengisi formulir laporan terkait masalah yang ditemukan mengenai air dan/atau sanitasi dengan cara mengunggah bukti yang mendukung (Foto, Video, dan sebagainya) serta mengisi deskripsi masalah. Laporan kemudian akan masuk untuk diproses validitasnya.* | *Pelapor* | *KF03* |
| *UC03* | *Menerima laporan dan memastikan validitas laporan* | *Pengguna mampu melihat dan memastikan validitas dari laporan yang diunggah oleh pelapor sesuai peran. Untuk petugas, bagian laporan yang dicek adalah kesesuaian jenis laporan agar tetap dalam lingkup air dan/atau sanitasi. Untuk admin, bagian yang dicek adalah kesesuian format laporan, seperti jenis file yang diunggah, ukuran file, jumlah karakter, dan sebagainya.Laporan yang valid akan diproses lebih lanjut penanganannya, sementara laporan yang tidak valid akan ditolak dan dikirimkan tanggapan ke pengguna terkait alasan penolakan.* | *Petugas, Admin* | *KF04* |
...
| *UC06* | *Memberi dan membatalkan like* | *Pengguna dapat memberikan like pada laporan yang dirasa perlu diprioritaskan. Apabila pengguna memiliki pendapat yang berbeda setelah memberikan like, pengguna dapat membatalkan like tersebut.* | *Pelapor* | *KF05, KF06, KF07, KF08* |
...
| *UC09* | *Melihat top 20 pada leaderboard* | *Pengguna dapat melihat peringkat 20 ke atas pada leaderboard beserta peringkatnya sendiri.* | *Pelapor* | *KF12, KF13, KF14* |
