...
| US-02 | *Pelapor* | *Membuat akun baru* | *Pengguna yang tidak memiliki akun ITB dapat mendaftar sebagai identitasnya di web* |
| US-03 | *Pelapor* |  *Melapor masalah fasilitas air dan/atau sanitasi* | *Masalah fasilitas dapat diketahui oleh petugas fasilitas dengan cepat* |
| US-04 | *Pelapor* | *Melampirkan foto dan deskripsi permasalahan yang dilapor* | *Petugas fasilitas dapat menanganinya dengan tepat* |
| US-05 | *Pelapor* | *Mendapatkan poin berdasarkan laporan yang dibuat* | *Menambah poin pada leaderboard untuk hadiah* |
| US-06 | *Pelapor* | *Mengetahui lokasi fasilitas air dan/atau sanitasi* | *Pengguna dapat mengetahui lokasi fasilitas terdekat untuk dituju* |
| US-07 | *Pelapor* | *Melihat laporan yang dibuat oleh orang lain* | *Menegetahui masalah yang sudah dilapor* |
| US-08 | *Pelapor* | *Melihat status laporan yang disampaikan* | *Mendapatkan transparansi terkait progres laporan yang dibuat* |
| US-09 | *Pelapor* | *Melakukan upvote/like pada laporan yang ada* | *Petugas dapat mengetahui masalah yang perlu diprioritas* |
| US-10 | *Pelapor* | *Mendapatkan merchandise* | *Pelapor dengan poin tinggi (Peringkat 20 ke atas) mendapatkan merchandise sebagai apresiasi atas kontribusinya dalam menjaga fasilitas* |
| US-11 | *Petugas* | *Memiliki akun* | *Petugas fasilitas secara otomatis terdaftar dalam sistem sebagai identitas di web* |
| US-12 | *Petugas* | *Menerima laporan masalah* | *Petugas dapat mengetahui masalah yang ada dengan detail dari pelapor* |
| US-13 | *Petugas* | *Menanggapi laporan yang masuk* | *Petugas dapat memberi tanggapan terhadap laporan sebagai bentuk transparansi* |
| US-14 | *Petugas* | *Memberi status laporan* | *Petugas dapat merubah status laporan berdasarkan progresnya* |
| US-15 | *Admin* | *Memproses validitas laporan* | *Memastikan masalah yang dilaporkan bersifat valid dari aspek teknis* |
| US-16 | *Admin* | *Memberi poin untuk laporan yang valid* | *Pelapor mendapatkan reward berupa poin* |
| US-17 | *Admin* | *Melakukan maintenance dan pembaruan sistem secara berkala* | *Memastikan kerja sistem sesuai dan minimalisir bug* |
...
| :--- | :--- | :--- | :--- |
| AK01 | Melakukan login pada web app | Pengguna akan login dengan akun ITB untuk mulai menggunakan web appnya. | US-01, US-11 |
| AK02 | Melaporkan masalah fasilitasi air dan/atau sanitasi | Pengguna melaporkan keluhan tentang fasilitas air yang ia gunakan. | US-03, US-04 |
| AK03 | Memvalidasi laporan | Admin akan melakukan filter agar konten laporan di web app sesuai. | US-14 |
| AK04 | Membaca laporan-laporan yang telah divalidasi | Pengguna mendapatkan informasi tentang fasilitas yang sedang rusak. | US-07 |
| AK05 | Like sebuah laporan | Pengguna dapat membawa atensi pada sebuah masalah yang telah dilaporkan pengguna lain agar fasilitas tersebut dapat diperbaiki lebih cepat oleh petugas. | US-09 |
| AK06 | Melihat lokasi-lokasi fasilitas air dan/atau sanitasi | Pengguna dapat mengetahui lokasi-lokasi fasilitas air dan/atau sanitasi yang rusak, dalam perbaikan, serta yang dapat digunakan. | US-06 |
| AK07 | Memberikan status laporan| Petugas memberikan status laporan berupa progres, seperti diterima, ditolak, dalam perbaikan, atau selesai. | US-13 |
| AK08 | Menerima dan menanggapi laporan | Laporan yang telah melalui proses validasi dapat diterima dan ditanggapi oleh petugas. | US-12, US-13 |
| AK09 | Memberikan poin kepada pelapor | Admin memberikan poin kepada pelapor berdasarkan validitas laporan yang diberikan. | US-16 |
| AK10 | Menerima poin | Pelapor memperoleh poin setelah mengirimkan laporan yang valid. | US-05 |
| AK11 | Melihat peringkat di leaderboard | Jumlah poin yang diperoleh menentukan peringkat di leaderboard. | US-05 |
| AK12 | Pemberian hadiah merchandise | Pelapor yang berada di peringkat 20 ke atas akan menerima merchandise berdasarkan peringkatnya. | US-10 |
| AK13 | Pembaruan poin dan leaderboard | Sistem melakukan pembaruan terhadap poin dan leaderboard setiap bulannya agar sistem reward tetap adil. | US-17 |
